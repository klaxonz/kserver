...
import com.klaxon.kserver.downloader.ytdlp.rsp.RequestedFormats;
...
public class DefaultDownloadCallback implements DownloadCallback {
    ...
    @Override
    @Transactional
    public DownloadState onBefore(WebPageTask webPageTask, VideoInfo videoInfo, String thumbnailPath) {
        ...
        return new DownloadState(videoInfo, webPageTask, webPageVideoTask);
    }

    @Override
    @Transactional
    public void onDownload(Progress progress, DownloadState state) {
    ...
    @Override
    public void onDownloadFinish(DownloadState state) {
        WebPageVideoTask webPageVideoTask = state.getWebPageVideoTask();
    ...
    @Override
    @Transactional
    public void onTaskFinish(List<DownloadState> stateList) {
